...
for required in {
    "agent_beacon/__init__.py",
    "agent_beacon/cli.py",
    "agent_beacon/http_url.py",
    "agent_beacon/server.py",
}:
...
for required in {
    ...
    f"{source_root}/python/agent_beacon/__init__.py",
    f"{source_root}/python/tests/test_beacon.py",
}:
